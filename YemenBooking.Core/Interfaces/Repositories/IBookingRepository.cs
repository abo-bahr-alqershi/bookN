...
public interface IBookingRepository : IRepository<Booking>
{
    ...
    /// <summary>
    /// إجمالي عدد الحجوزات ضمن فترة محددة (اختياريًا حسب العقار)
    ...
    /// <summary>
    /// إجمالي الإيرادات ضمن فترة محددة (اختياريًا حسب العقار)
    ...
    /// <summary>
    /// الحصول على الحجوزات القادمة (Check-ins) الخاصة بالعقار خلال الأيام القادمة
