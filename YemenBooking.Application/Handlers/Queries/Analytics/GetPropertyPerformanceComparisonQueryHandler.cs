...
{
    /// <summary>
    /// معالج استعلام مقارنة أداء العقار بين فترتين زمنيتين
    ...
    public class GetPropertyPerformanceComparisonQueryHandler : IRequestHandler<GetPropertyPerformanceComparisonQuery, ResultDto<PerformanceComparisonDto>>
    {
        ...
        {
            _logger.LogInformation("بدء مقارنة أداء العقار: {PropertyId} من {CurrentStart}-{CurrentEnd} مقابل {PrevStart}-{PrevEnd}",
            ...
            if (request.PropertyId == Guid.Empty)
            {
                ...
                return ResultDto<PerformanceComparisonDto>.Failure("معرف العقار غير صالح");
            }
