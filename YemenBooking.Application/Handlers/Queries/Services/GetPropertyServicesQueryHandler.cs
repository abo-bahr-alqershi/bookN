...
{
    /// <summary>
    /// معالج استعلام الحصول على خدمات العقار
    ...
    public class GetPropertyServicesQueryHandler : IRequestHandler<GetPropertyServicesQuery, ResultDto<IEnumerable<ServiceDto>>>
    {
        ...
        {
            _logger.LogInformation("جاري معالجة استعلام خدمات العقار: {PropertyId}", request.PropertyId);
            ...
            return ResultDto<IEnumerable<ServiceDto>>.Ok(dtos, "تم جلب خدمات العقار بنجاح");
        }
    }
} 