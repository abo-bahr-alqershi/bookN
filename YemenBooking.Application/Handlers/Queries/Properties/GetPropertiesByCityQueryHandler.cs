...
{
    /// <summary>
    /// معالج استعلام الحصول على العقارات حسب المدينة
    ...
    public class GetPropertiesByCityQueryHandler : IRequestHandler<GetPropertiesByCityQuery, PaginatedResult<PropertyDto>>
    {
        ...
        {
            _logger.LogInformation("بدء جلب العقارات في المدينة: {CityName} - الصفحة: {PageNumber}, الحجم: {PageSize}",
            ...
            _logger.LogInformation("تم جلب {Count} عقار من إجمالي {TotalCount} في المدينة", dtos.Count, totalCount);
