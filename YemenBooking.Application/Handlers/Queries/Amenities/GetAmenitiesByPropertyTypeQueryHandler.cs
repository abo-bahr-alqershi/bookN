...
{
    /// <summary>
    /// معالج استعلام الحصول على مرافق نوع العقار
    ...
    public class GetAmenitiesByPropertyTypeQueryHandler : IRequestHandler<GetAmenitiesByPropertyTypeQuery, ResultDto<IEnumerable<AmenityDto>>>
    {
        ...
        {
            _logger.LogInformation("جاري معالجة استعلام مرافق نوع العقار: {PropertyTypeId}", request.PropertyTypeId);
            ...
            return ResultDto<IEnumerable<AmenityDto>>.Ok(dtos, "تم جلب مرافق نوع العقار بنجاح");
        }
    }
} 