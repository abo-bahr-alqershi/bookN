...
{
    /// <summary>
    /// معالج استعلام الحصول على نوع عقار محدد
    ...
    public class GetPropertyTypeByIdQueryHandler : IRequestHandler<GetPropertyTypeByIdQuery, ResultDto<PropertyTypeDto>>
    {
        ...
        {
            _logger.LogInformation("جاري معالجة استعلام نوع العقار: {PropertyTypeId}", request.PropertyTypeId);
            ...
            if (pt == null)
                return ResultDto<PropertyTypeDto>.Failure($"نوع العقار بالمعرف {request.PropertyTypeId} غير موجود");
            ...
            return ResultDto<PropertyTypeDto>.Ok(dto, "تم جلب نوع العقار بنجاح");
        }
    }
} 