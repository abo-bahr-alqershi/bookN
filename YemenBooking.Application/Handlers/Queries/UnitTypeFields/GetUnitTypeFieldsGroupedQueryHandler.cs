...
namespace YemenBooking.Application.Handlers.Queries.UnitTypeFields
{
    ...
    public class GetUnitTypeFieldsGroupedQueryHandler : IRequestHandler<GetUnitTypeFieldsGroupedQuery, List<FieldGroupWithFieldsDto>>
    {
        ...
        {
            _logger.LogInformation("جاري معالجة استعلام الحقول مجمعة حسب المجموعات لنوع العقار: {PropertyTypeId}", request.PropertyTypeId);
            ...
            var groups = await _groupRepo.GetGroupsByPropertyTypeIdAsync(typeId, cancellationToken);
