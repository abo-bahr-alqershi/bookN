...
{
    /// <summary>
    /// معالج استعلام الحصول على سياسات العقار
    ...
    public class GetPropertyPoliciesQueryHandler : IRequestHandler<GetPropertyPoliciesQuery, ResultDto<IEnumerable<PolicyDto>>>
    {
        ...
        {
            _logger.LogInformation("جاري معالجة استعلام سياسات العقار: {PropertyId}", request.PropertyId);
            ...
            return ResultDto<IEnumerable<PolicyDto>>.Ok(dtos, "تم جلب سياسات العقار بنجاح");
        }
    }
} 