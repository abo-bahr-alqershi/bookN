...
{
    /// <summary>
    /// معالج أمر تسجيل مالك عقار جديد مع بيانات العقار الكاملة
    /// </summary>
    public class RegisterPropertyOwnerCommandHandler : IRequestHandler<RegisterPropertyOwnerCommand, ResultDto<OwnerRegistrationResultDto>>
    {
        ...
        {
            _logger.LogInformation("بدء تسجيل مالك عقار جديد: Email={Email}, Name={Name}", request.Email, request.Name);
            ...
            // إنشاء العقار مع الحقول الديناميكية
            ...
            await _auditService.LogBusinessOperationAsync(
                ...
                $"تم تسجيل مالك عقار جديد {createdUser.Id} مع العقار {propertyResult.Data}",
                createdUser.Id,
                "User",
            ...
            _logger.LogInformation("تم تسجيل مالك العقار بنجاح: UserId={UserId}, PropertyId={PropertyId}", createdUser.Id, propertyResult.Data);
