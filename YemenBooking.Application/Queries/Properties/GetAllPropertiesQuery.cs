...
/// <summary>
/// استعلام للحصول على جميع العقارات
...
public class GetAllPropertiesQuery : IRequest<PaginatedResult<PropertyDto>>
{
    ...
    /// <summary>
    /// فلترة بالمرافق: السماح باختيار عقارات تحتوي على كل المرافق المحددة
    /// Amenity filter: include only properties containing all specified amenities
    /// </summary>
    public IEnumerable<Guid>? AmenityIds { get; set; }

    /// <summary>
    /// فلترة بالتقييم النجمي: عرض العقارات ذات التقييمات المحددة
