        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyTypeId = table.Column<Guid>(type: "TEXT", nullable: false, comment: "معرف نوع العقار"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UnitTypeFields_FieldTypes_FieldTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyId = table.Column<Guid>(type: "TEXT", nullable: false, comment: "معرف العقار"),
                    PtaId = table.Column<Guid>(type: "TEXT", nullable: false, comment: "معرف مرفق نوع العقار"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookedAt = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "GETUTCDATE()", comment: "تاريخ الحجز"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_Properties_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Properties",
                        principalColumn: "PropertyId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(7448), null, null, null, "إنترنت لاسلكي مجاني", true, "واي فاي", new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(7448), null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8147), null, null, null, "مسبح للسباحة", true, "مسبح", new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8148), null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8160), null, null, null, "صالة رياضية", true, "جيم", new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8161), null },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8171), null, null, null, "خدمة المطعم", true, "مطعم", new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8171), null },
                    { new Guid("55555555-5555-5555-5555-555555555555"), new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8180), null, null, null, "موقف سيارات مجاني", true, "موقف سيارات", new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8180), null },
                    { new Guid("66666666-6666-6666-6666-666666666666"), new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8190), null, null, null, "تكييف الهواء", true, "تكييف", new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8190), null },
                    { new Guid("77777777-7777-7777-7777-777777777777"), new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8200), null, null, null, "تلفزيون بشاشة مسطحة", true, "تلفزيون", new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8200), null },
                    { new Guid("88888888-8888-8888-8888-888888888888"), new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8209), null, null, null, "وجبة إفطار مجانية", true, "إفطار", new DateTime(2025, 7, 10, 23, 33, 45, 66, DateTimeKind.Utc).AddTicks(8209), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2025, 7, 10, 23, 33, 44, 911, DateTimeKind.Utc).AddTicks(9258), null, "[]", null, null, "فندق تقليدي بغرف وخدمات فندقية", true, "فندق", new DateTime(2025, 7, 10, 23, 33, 44, 911, DateTimeKind.Utc).AddTicks(9258), null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2025, 7, 10, 23, 33, 44, 912, DateTimeKind.Utc).AddTicks(290), null, "[]", null, null, "شاليه للعائلات والمجموعات", true, "شاليه", new DateTime(2025, 7, 10, 23, 33, 44, 912, DateTimeKind.Utc).AddTicks(290), null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2025, 7, 10, 23, 33, 44, 912, DateTimeKind.Utc).AddTicks(305), null, "[]", null, null, "استراحة للإقامة المؤقتة", true, "استراحة", new DateTime(2025, 7, 10, 23, 33, 44, 912, DateTimeKind.Utc).AddTicks(306), null },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 7, 10, 23, 33, 44, 912, DateTimeKind.Utc).AddTicks(315), null, "[]", null, null, "فيلا خاصة للإقامة الفاخرة", true, "فيلا", new DateTime(2025, 7, 10, 23, 33, 44, 912, DateTimeKind.Utc).AddTicks(315), null },
                    { new Guid("55555555-5555-5555-5555-555555555555"), new DateTime(2025, 7, 10, 23, 33, 44, 912, DateTimeKind.Utc).AddTicks(327), null, "[]", null, null, "شقة مفروشة للإقامة قصيرة أو طويلة المدى", true, "شقة", new DateTime(2025, 7, 10, 23, 33, 44, 912, DateTimeKind.Utc).AddTicks(328), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2025, 7, 10, 23, 33, 44, 900, DateTimeKind.Utc).AddTicks(1008), null, null, null, true, "Admin", new DateTime(2025, 7, 10, 23, 33, 44, 900, DateTimeKind.Utc).AddTicks(1008), null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2025, 7, 10, 23, 33, 44, 900, DateTimeKind.Utc).AddTicks(2475), null, null, null, true, "Owner", new DateTime(2025, 7, 10, 23, 33, 44, 900, DateTimeKind.Utc).AddTicks(2475), null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2025, 7, 10, 23, 33, 44, 900, DateTimeKind.Utc).AddTicks(2572), null, null, null, true, "Manager", new DateTime(2025, 7, 10, 23, 33, 44, 900, DateTimeKind.Utc).AddTicks(2572), null },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 7, 10, 23, 33, 44, 900, DateTimeKind.Utc).AddTicks(2584), null, null, null, true, "Customer", new DateTime(2025, 7, 10, 23, 33, 44, 900, DateTimeKind.Utc).AddTicks(2585), null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnitTypeFields_FieldTypeId",
