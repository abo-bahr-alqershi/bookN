...
namespace YemenBooking.Infrastructure.Services
{
    ...
    public class RecommendationService : IRecommendationService
    {
        ...
        {
            _logger.LogInformation("الحصول على توصيات لعقارات للمستخدم: {UserId}", userId);
        ...
        {
            _logger.LogInformation("الحصول على عقارات مشابهة للمعرف: {PropertyId}", propertyId);
        ...
        {
            _logger.LogInformation("حساب درجة التوافق للمستخدم: {UserId} والعقار: {PropertyId}", userId, propertyId);
            // حساب وهمي للدرجة
